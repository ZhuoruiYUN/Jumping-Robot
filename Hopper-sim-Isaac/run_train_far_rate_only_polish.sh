...
"$ISAAC_SIM_ROOT/python.sh" "$SCRIPT_DIR/train_planner_circular.py" \
  ...
  --airborne_stability_scale 0.0 \
  --safety_yaw_scale 1.0 \
  --safety_attitude_scale 0.65 \
  --safety_angular_vel_scale 0.65 \
  --safety_height_scale 1.10 \
  --damping_airborne_angvel_start 1.20 \
  --damping_airborne_angvel_scale 1.2 \
  --damping_action_spread_scale 10.0 \
  --damping_action_rate_scale 0.8 \
  --damping_yaw_rate_start 0.90 \
  --damping_yaw_rate_scale 0.06 \
